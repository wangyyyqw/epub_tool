...
class Ui_edit_regexp(object):
    def setupUi(self, edit_regexp):
        ...
        self.exp_tree = QtWidgets.QTreeWidget(edit_regexp)
        self.exp_tree.setStyleSheet("alternate-background-color:rgb(235, 235, 235);")
        self.exp_tree.setAlternatingRowColors(True)
        self.exp_tree.setObjectName("exp_tree")
        self.exp_tree.headerItem().setText(0, "1")
